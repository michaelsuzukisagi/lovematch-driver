 ...
 * @since 1.0
 */
public class ScheduleLoveMatchProcesses extends AbstractEventProcessor
{
    public static final int DEFAULT_BATCH_SIZE = 100;
    public static final String EVENT_NAME_PROCESS = "getLoveMatch";
    
    private static Log logger = LogFactory.getLog(ScheduleLoveMatchProcesses.class);
     ...
     */
    public ScheduleLoveMatchProcesses(
